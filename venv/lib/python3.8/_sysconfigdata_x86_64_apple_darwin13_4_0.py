...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'x86_64-apple-darwin13.4.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/workspaces/Demo.Pipeline/venv/lib '
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/workspaces/Demo.Pipeline/venv=/usr/local/src/conda-prefix '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-pie -Wl,-headerpad_max_install_names '
                      ...
                      '-L/workspaces/Demo.Pipeline/venv/lib '
                      '-flto -Wl,-export_dynamic',
 'CONFIG_ARGS': "'--prefix=/workspaces/Demo.Pipeline/venv' "
 ...
 'LIBFFI_INCLUDEDIR': '/workspaces/Demo.Pipeline/venv/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/workspaces/Demo.Pipeline/venv/lib/pkgconfig',
 'LIBPL': '/workspaces/Demo.Pipeline/venv/lib/python3.8/config-3.8-darwin',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/workspaces/Demo.Pipeline/venv/include',
 'OPENSSL_LDFLAGS': '-L/workspaces/Demo.Pipeline/venv/lib',
